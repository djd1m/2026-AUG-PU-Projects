#!/bin/sh
# из N5: projects/05-podcast-clips-opus/scripts/check-env-complete.sh — текст про QUOTA_* N6
...
# Все 14 QUOTA_* проверяются по обязательному x-quota-env без отдельного списка.
