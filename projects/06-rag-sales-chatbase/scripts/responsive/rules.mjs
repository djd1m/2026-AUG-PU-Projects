// из N5: projects/05-podcast-clips-opus/scripts/responsive/rules.mjs (коммит 90fe80a) — правила R1–R9 и перепроверка
// контраста без изменений; FIRST_SCREEN_ACTIONS — маршруты N6 (навык responsive-ui, правило 13).
...
// «/» (FR-LOOK-001, 007): ОДНО поле «адрес сайта» и ОДИН призыв «Создать бота» — оба в первом экране.
