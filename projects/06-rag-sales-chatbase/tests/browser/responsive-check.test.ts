// из N5: projects/05-podcast-clips-opus/tests/browser/responsive-check.test.ts (коммит 90fe80a) — правила прибора R1–R9 на
// фикстурах с внедрённым дефектом без изменений; убраны разделы N5 (/c/, лендинг клипов, палитра N5) — страницы N6
// проверяет tests/browser/design-shell.test.ts.
