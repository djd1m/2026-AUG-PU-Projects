...
Таблица 26 строк `SC-US-nnn-k → именованный сценарий` — в квитанции validator-stories-ac, раздел
«Criterion scenarios»; сами сценарии — [`test-scenarios.md`](test-scenarios.md) (101 сценарий: happy/error/edge по
22 FR, 7 security по FR-GROWTH, 26 трассировочных по US).
