...
Coordinator routing: CAVEATS (vendor vocabulary); independent REVIEW verdict has no PLAN blockers and allows core work. Shared billing integration remains gated on V-02 ownership/lock contract.
