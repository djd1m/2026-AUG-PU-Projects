...
describe('страницы верстаются дизайн-системой, а не сырыми утилитами', () => {
  ...
  // Список ЗАШИТ, и это его слабость: страница, не внесённая сюда, проверку обходит.
  // Дашборд в него не входил, поэтому форма смены пароля (FR-010.4) внесена явно —
  // иначе она верстается как угодно и повторяет историю «тёмное на тёмном».
  const PAGES = [
    'app/page.tsx',
    'app/login/page.tsx',
    'app/login/login-form.tsx',
    'app/dashboard/[slug]/change-password.tsx',
