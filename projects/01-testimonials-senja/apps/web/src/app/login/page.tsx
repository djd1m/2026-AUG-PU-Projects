...
const SSO_MESSAGES: Record<string, string> = {
  ...
  password_account_exists:
    'Эта почта уже связана с аккаунтом. Войдите прежним способом: паролем или тем же Яндекс ID, которым создавали аккаунт. Другой Яндекс ID не может получить доступ только по совпадению почты.',
