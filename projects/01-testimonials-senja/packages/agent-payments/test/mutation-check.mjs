...
const mutations=[
  ...
  {name:'settlement-deduplication',file:'dist/settlement.js',from:"if (order.paymentStatus === 'succeeded') {",to:"if (false) {",test:'direct verified settlement replay',suite:'test/followup.test.mjs'},
];
for(const m of mutations) {
  ...
  try {
    ...
    const result=spawnSync(process.execPath,['--test',`--test-name-pattern=${m.test}`,m.suite??'test/postgres.test.mjs'],{encoding:'utf8'});
