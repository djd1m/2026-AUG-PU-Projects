...
в начале клипа (ADR-013). Затем RT-002/RT-009 (ADR-014), уплотнение пауз (ADR-015), каталог музыки из 9 треков, прослушанных владельцем. Затем смена музыки у готового клипа (ADR-016). Всего **22 фичи**, тесты — **786 из 786** на настоящих PostgreSQL 16, Redis 7
...
`music-library`, `teaser-headline`, `partner-fairness`, `pause-compaction`, `clip-music-choice`. Указатель с доказательствами — `docs/features/README.md`.
