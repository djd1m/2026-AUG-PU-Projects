...
function createUploadRuntime() {
  ...
  return { video, guests: new GuestPackService(runtime.pool), links: new ShortLinkService(runtime.pool), screen: new ScreenService(runtime.pool), retry: queueRuntime.retry, auth: runtime.auth, publicOrigin: runtime.config.publicOrigin,
