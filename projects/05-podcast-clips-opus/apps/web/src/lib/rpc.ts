type RpcMethod = 'code.apply' | 'partner.dashboard' | 'video.get' | 'video.list' | 'clip.list' | 'video.create' | 'video.retry' | 'clip.markDownloaded' | 'link.create' | 'guest.create' | 'guest.send' | 'guest.revoke';
