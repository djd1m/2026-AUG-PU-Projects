import { FRAGMENTS_SCHEMA } from '@clipmaker/shared/fragments';
...
export const SYSTEM_PROMPT = `Ты анализируешь русскоязычный подкаст. Выбери ${count.minItems}–${count.maxItems}
...
завершённой мыслью. Не выдумывай и не добирай слабые фрагменты ради количества.
