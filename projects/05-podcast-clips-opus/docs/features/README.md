...
Все двадцать три — `done` на 25.09.2026 (16–23 добавлены 24–25.09). Двенадцать — MVP по плану; три появились после первого живого
...
| 27 | `clip-cta` | Призыв в конце клипа: 27a — выбор и кнопка «Смотреть полный выпуск» на /c/ (27b — надпись в кадре) | post-mvp | [05_completion.md](clip-cta/05_completion.md) |
