...
На GitHub HTML скачивают через Download raw file и открывают в браузере. Файлы автономны, установка не нужна. Папки пока содержат документы и текущие демонстрации; общий backend и четыре функциональных UI-варианта ещё не реализованы. Выбор будущего продукта может быть сочетанием вариантов.
