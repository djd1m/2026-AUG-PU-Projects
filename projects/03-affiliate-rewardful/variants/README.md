...
F1 использует синтетические данные. UI E2E49/49; реальные платежи, production identity и MCP/A2A wire не подключены. Статические CJM сохранены в `prototype/`; функциональные стенды запускаются через Docker. HTML-инструкцию на GitHub можно скачать через Download raw file и открыть локально; сам UI доступен по публичным HTTPS-ссылкам без SSH. Можно выбрать сочетание удачных частей разных вариантов.
