...
На VPS: `https://n3-a.212.192.0.33.sslip.io/`. Для своего браузера подключите SSH-туннель `ssh -L 13031:127.0.0.1:13031 пользователь@VPS`, затем откройте этот адрес локально. БД не требует и не имеет опубликованного порта.
