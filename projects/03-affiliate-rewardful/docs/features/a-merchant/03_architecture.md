# Architecture — a-merchant

Distributed monolith in Docker. Canon: [runtime-contract](../../runtime-contract.md) and [Architecture](../../Architecture.md).

This unit owns `variants/a-merchant/app/` and variant browser tests. Browser imports only shared/client, shared/contracts, shared/ui; never other variants, pg or server modules.
