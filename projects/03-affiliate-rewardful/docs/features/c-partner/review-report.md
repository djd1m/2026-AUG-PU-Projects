...
Status: accepted F1; initial C1 resolved and independently rechecked at d0d7403.
...
## Initial decision (superseded by resolved follow-up below)
...
C F1 accepted after actual desktop/mobile390/reload/keyboards, own read grants, denied foreign partner and merchant registry, confirmed send with bank credit unknown, initial lab network failure/retry and limited partner session. Tests11/11, full42/42, mutants10/10killed. Initial browser attempt had two harness defects (case-sensitive Russian copy assertion and top-level refresh from mobile frame); corrected and full C rerun passed. Implementation source unchanged during browser verification. Evidence: `../../telemetry/p-replicator/20260909T070308Z-go-c-partner/evidence/`.
