...
for(const [name,url] of pages){
 ...
 await open('http://127.0.0.1:13031/mobile.html');await js('document.querySelector("#mobile-frame").src=arguments[0]',url);
 await wd('/frame',{id:await element('#mobile-frame')});await until('return !!document.querySelector("main h1")');
