...
На 9 сентября: общее ядро работает в Docker/PostgreSQL; варианты [A](variants/a-merchant/README.md), [B](variants/b-customer/README.md) и [C](variants/c-partner/README.md) прошли приёмку F1. D реализуется. Последняя совместная браузерная проверка A/B: 25/25 тестов; общий набор: 42/42. Это стенды с синтетическими платежами. Инструкции открытия через SSH находятся в README вариантов.
...
| Phase 4 — Finalize | Общая приёмка ожидает D |
| Реализация | Ядро и A/B/C работают; D в работе |
...
Подготовлены 4 PRD и общий план. A/B/C используют общий работающий API; D подключается следующим.
