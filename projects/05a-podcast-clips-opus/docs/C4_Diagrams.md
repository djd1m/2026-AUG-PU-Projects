...
C4Component
  ...
  Container_Boundary(rw, "worker-render") {
    ...
    Component(ffmpeg, "FFmpeg runner", "execFile без shell", "-ss по подписанной ссылке (HTTP range); scale=1080:-2, pad=1080:1920:0:420:black; ass=; знак полупрозрачный в углу полосы видео; -threads 2; таймаут 5 мин")
